...
const REGULACION = [
  ...
  { icon: 'fa-blanket',        color: 'text-acc',   bg: 'bg-acc/8',   titulo: 'Presión',         desc: 'Manta con peso, chaqueta apretada o simplemente abrazar las rodillas. La presión profunda regula el sistema nervioso.' },
...
const KITS = [
  {
    ...
    items: [
      ...
      { icon: 'fa-card-blank',  label: 'Tarjeta de crisis',     nota: 'Con tu info y necesidades' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'fa-card-blank',     label: 'Tarjeta de crisis',     nota: 'AAC o texto simple' },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: 'fa-card-blank',     label: 'Tarjetas de apoyo',      nota: 'Crisis, necesidades, AAC' },
      ...
      { icon: 'fa-blanket',        label: 'Mantita pequeña',        nota: 'Peso o confort táctil' },
