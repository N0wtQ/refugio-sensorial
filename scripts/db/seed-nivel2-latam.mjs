...
const filas = [
  ...
  ['LVL2-231', 'Museo Nacional de Arte (MUNAL)', 'Ciudad de México', 'CDMX', 'México', 'MX', 'https://munal.inba.gob.mx', 'Museos y cultura', 'Museo', 'cultura', 19.435164, -99.137000, 'Museo con accesibilidad universal.'],
  ...
  ['LVL2-236', 'Parque Bicentenario', 'Ciudad de México', 'CDMX', 'México', 'MX', 'https://parquebicentenario.cdmx.gob.mx', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', null, null, 'Gran parque urbano con zonas tranquilas y accesibilidad.'],
  ['LVL2-237', 'Biblioteca Vasconcelos', 'Ciudad de México', 'CDMX', 'México', 'MX', 'https://bibliotecavasconcelos.cultura.gob.mx', 'Bibliotecas y estudio', 'Biblioteca', 'biblioteca', 19.446520, -99.150854, 'Gran biblioteca con ambientes silenciosos y accesibles.'],
  ...
  ['LVL2-241', 'Zoológico Guadalajara', 'Guadalajara', 'Jalisco', 'México', 'MX', 'https://www.zoogdl.com.mx', 'Parques y naturaleza', 'Zoológico', 'zoologico_acuario', 20.728830, -103.306972, 'Zoológico con programas de inclusión y accesibilidad.'],
  ...
  ['LVL2-247', 'Parque Metropolitano de Santiago', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://www.parquemet.cl', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -33.477669, -70.642364, 'Parque urbano con múltiples zonas de descanso y accesibilidad.'],
  ['LVL2-248', 'Biblioteca de Santiago', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://www.bibliotecadesantiago.gob.cl', 'Bibliotecas y estudio', 'Biblioteca', 'biblioteca', null, null, 'Biblioteca pública con salas de lectura silenciosas y accesibles.'],
  ...
  ['LVL2-251', 'Centro Cultural La Moneda', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://www.ccplm.cl', 'Museos y cultura', 'Centro cultural', 'centro_civico', -33.443900, -70.653600, 'Centro cultural con recursos de inclusión para visitantes.'],
  ...
  ['LVL2-254', 'Museo de la Memoria y los Derechos Humanos', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://ww3.museodelamemoria.cl', 'Museos y cultura', 'Museo', 'cultura', -33.439840, -70.679380, 'Museo con programas de inclusión y accesibilidad.'],
  ['LVL2-255', 'Biblioteca Regional Gabriela Mistral', 'La Serena', 'Coquimbo', 'Chile', 'CL', 'https://www.bibliotecaspublicas.gob.cl', 'Bibliotecas y estudio', 'Biblioteca', 'biblioteca', null, null, 'Biblioteca pública con salas silenciosas.'],
  ['LVL2-256', 'Parque Quinta Normal', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://www.parquemet.cl', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -33.440716, -70.682594, 'Parque urbano con amplias zonas verdes.'],
  ['LVL2-257', 'Parque Forestal', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://www.providencia.cl', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -33.435657, -70.641269, 'Parque céntrico con ambiente tranquilo y senderos peatonales.'],
  ['LVL2-258', 'Parque Bicentenario (Vitacura)', 'Santiago', 'Región Metropolitana', 'Chile', 'CL', 'https://parquemet.cl/parque-bicentenario', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -33.399900, -70.602200, 'Parque urbano con senderos accesibles y zonas de descanso.'],

  // ── Buenos Aires
  ['LVL2-259', 'Museo del Niño Abasto', 'Buenos Aires', 'CABA', 'Argentina', 'AR', 'https://www.museodelosninos.com.ar', 'Museos y cultura', 'Museo interactivo', 'cultura', -34.603867, -58.411083, 'Museo interactivo con actividades inclusivas para familias y niños.'],
  ...
  ['LVL2-263', 'Centro Cultural Kirchner', 'Buenos Aires', 'CABA', 'Argentina', 'AR', 'https://www.cck.gob.ar', 'Museos y cultura', 'Centro cultural', 'centro_civico', -34.603634, -58.369835, 'Centro cultural con medidas de accesibilidad.'],
  ['LVL2-264', 'Ecoparque de Buenos Aires', 'Buenos Aires', 'CABA', 'Argentina', 'AR', 'https://www.ecoparqueba.gob.ar', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -34.581400, -58.420220, 'Parque con senderos accesibles y ambiente de baja estimulación.'],
  ...
  ['LVL2-271', 'Parque Ibirapuera', 'São Paulo', 'São Paulo', 'Brasil', 'BR', 'https://parqueibirapuera.org', 'Parques y naturaleza', 'Parque urbano', 'espacio_natural', -23.588333, -46.658890, 'Gran parque urbano con numerosas zonas de calma.'],
  ...
  ['LVL2-273', 'Museu Catavento', 'São Paulo', 'São Paulo', 'Brasil', 'BR', 'https://cataventocultural.org.br', 'Museos y cultura', 'Museo interactivo', 'cultura', -23.544012, -46.627679, 'Museo interactivo con actividades adaptadas y accesibilidad.'],
  ...
  ['LVL2-278', 'Jardim Botânico do Rio de Janeiro', 'Rio de Janeiro', 'Rio de Janeiro', 'Brasil', 'BR', 'https://jbrj.gov.br', 'Parques y naturaleza', 'Jardín botánico', 'espacio_natural', -22.968197, -43.225933, 'Jardín botánico con recorridos tranquilos y accesibles.'],
]
