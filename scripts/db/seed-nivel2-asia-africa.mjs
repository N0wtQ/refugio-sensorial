...
const filas = [
  ...
  ['LVL2-011', 'S.E.A. Aquarium', 'Singapur', 'SG', 'https://www.rwsentosa.com', 'Parques y naturaleza', 'Acuario', 'zoologico_acuario', 1.255940, 103.818690, 'Acuario con accesibilidad y espacios adaptados.'],
  ...
  ['LVL2-016', 'National Museum of Singapore', 'Singapur', 'SG', 'https://www.nhb.gov.sg', 'Museos y cultura', 'Museo', 'cultura', 1.296638, 103.848665, 'Museo con servicios de accesibilidad para todos los visitantes.'],
  ['LVL2-017', 'Hamad International Airport', 'Catar', 'QA', 'https://dohahamadairports.com', 'Transporte', 'Aeropuerto', 'aeropuerto', 25.260595, 51.613767, 'Aeropuerto con salas de asistencia y servicios de accesibilidad.'],
  ['LVL2-018', 'Hamad International Airport – Orchard (Quiet Room)', 'Catar', 'QA', 'https://dohahamadairports.com', 'Transporte', 'Aeropuerto', 'aeropuerto', 25.260595, 51.613767, 'Zona tranquila destinada a reducir la sobrecarga sensorial.'],
  ...
  ['LVL2-029', 'COEX Aquarium', 'Corea del Sur', 'KR', 'https://www.coexaqua.com', 'Parques y naturaleza', 'Acuario', 'zoologico_acuario', 37.512441, 127.058869, 'Acuario con rutas accesibles.'],
  ...
  ['LVL2-040', 'National Museum of Singapore', 'Singapur', 'SG', 'https://www.nhb.gov.sg/nationalmuseum', 'Museos y cultura', 'Museo', 'cultura', 1.296638, 103.848665, 'Museo con programas de inclusión y accesibilidad.'],
  ...
  ['LVL2-044', 'Chiang Mai Zoo', 'Tailandia', 'TH', 'https://www.chiangmaizoo.com', 'Parques y naturaleza', 'Zoológico', 'zoologico_acuario', 18.809000, 98.947000, 'Zoológico con rutas accesibles.'],
  ...
  ['LVL2-049', 'National Museum of Indonesia', 'Indonesia', 'ID', 'https://museum.kemdikbud.go.id', 'Museos y cultura', 'Museo', 'cultura', null, null, 'Museo nacional con accesibilidad.'],
  ...
  ['LVL2-056', 'Nehru Planetarium Bengaluru', 'India', 'IN', 'https://taralaya.in', 'Museos y cultura', 'Planetario', 'cultura', 12.984570, 77.590100, 'Planetario con instalaciones accesibles.'],
  ...
  ['LVL2-064', 'Johannesburg Zoo', 'Sudáfrica', 'ZA', 'https://jhbzoo.org.za', 'Parques y naturaleza', 'Zoológico', 'zoologico_acuario', -26.167778, 28.037857, 'Zoológico con rutas adaptadas para visitantes.'],
  ...
  ['LVL2-067', 'Grand Egyptian Museum', 'Egipto', 'EG', 'https://gem.gov.eg', 'Museos y cultura', 'Museo', 'cultura', 29.995000, 31.119300, 'Gran museo con instalaciones accesibles.'],
  ...
  ['LVL2-071', 'Mohammed VI Museum of Modern and Contemporary Art', 'Marruecos', 'MA', 'https://www.musee-mmvi.ma', 'Museos y cultura', 'Museo', 'cultura', null, null, 'Museo con instalaciones accesibles.'],
  ['LVL2-072', "Jardin d'Essais Botaniques", 'Argelia', 'DZ', 'https://www.jardin-essai.dz', 'Parques y naturaleza', 'Jardín botánico', 'espacio_natural', null, null, 'Jardín botánico con amplios espacios tranquilos.'],
  ...
  ['LVL2-075', 'Kigali Public Library', 'Ruanda', 'RW', 'https://kglfoundation.org', 'Bibliotecas y estudio', 'Biblioteca', 'biblioteca', null, null, 'Biblioteca pública con espacios silenciosos.'],
  ...
  ['LVL2-106', 'National Museum of Singapore', 'Singapur', 'SG', 'https://www.nhb.gov.sg', 'Museos y cultura', 'Museo', 'cultura', 1.296638, 103.848665, 'Museo con recursos de inclusión y accesibilidad.'],
  ...
  ['LVL2-116', 'Oman Across Ages Museum', 'Omán', 'OM', 'https://www.omanmuseum.om', 'Museos y cultura', 'Museo', 'cultura', 22.776190, 57.554456, 'Museo moderno con instalaciones accesibles.'],
